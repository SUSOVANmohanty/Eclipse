...
public class FB {
	...
	public static void main(String[] args) throws InterruptedException, AWTException {
		...
		//click on post section field 
		driver.findElement(By.xpath("//span[contains(text(),\"What's on your mind, Susovan?\")]")).click();
		Thread.sleep(3000);
		driver.findElement(By.cssSelector("p[class='xdj266r x11i5rnm xat24cr x1mh8g0r x16tdsg8']")).sendKeys("ooo");
		Thread.sleep(6000);
		...
		//type casting the javascriptExcecutor for scroll down 
		...
		//click on comment and give the values in comment section
		...
		//using robot keys again for clicking on comment section
		robot.keyPress(KeyEvent.VK_ENTER);
		robot.keyRelease(KeyEvent.VK_ENTER);
		je.executeScript("window.scrollBy(0,500)", "");
		
		//frnd request scenario
